...
public class Player extends Human{
	...
	public Player(GamePanel gp, KeyHandler keyH, int absX, int absY, int speed, int person_num) {
	...
	public void loadImages() {
		try {
			up1 = ImageIO.read(getClass().getResourceAsStream(package_name+folder_name+"/player2_4.png"));
			up2 = ImageIO.read(getClass().getResourceAsStream(package_name+folder_name+"/player2_5.png"));
		}catch(IOException e){
			e.printStackTrace();
		}
	}
