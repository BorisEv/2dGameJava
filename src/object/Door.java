	...
	public void draw(Graphics2D g2d) {
		if(animated == true) {
			if(animationCounter == 15) {
				...
				animationCounter = 0;
				gp.human1.pathList = gp.human1.find_path(gp.human1.absX/gp.tileSize, gp.human1.absY/gp.tileSize, 2, 17, gp.collisionsMap);
				gp.human1.pathList.addAll(gp.human1.find_path(2, 17, 6, 6, gp.collisionsMap));
				try {
