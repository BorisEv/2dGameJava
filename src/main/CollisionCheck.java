...
public class CollisionCheck {
	...
	public void checkTile(Creature creature) {
		...
		case "up":
			...
			tile1 = gp.collisionsMap[creature.worldNumber][leftCol][topRow];
			tile2 = gp.collisionsMap[creature.worldNumber][rightCol][topRow];
		...
		case "down":
			...
			tile1 = gp.collisionsMap[creature.worldNumber][leftCol][bottomRow];
			tile2 = gp.collisionsMap[creature.worldNumber][rightCol][bottomRow];
			if(tile1 == 1 || tile2 == 1) {
				creature.collision = true;
			}
			break;
		case "left":
			...
			tile1 = gp.collisionsMap[creature.worldNumber][leftCol][topRow];
			tile2 = gp.collisionsMap[creature.worldNumber][leftCol][bottomRow];
			if(tile1 == 1 || tile2 == 1) {
				creature.collision = true;
			}
			break;
		case "right":
			...
			tile1 = gp.collisionsMap[creature.worldNumber][rightCol][topRow];
			tile2 = gp.collisionsMap[creature.worldNumber][rightCol][bottomRow];
			if(tile1 == 1 || tile2 == 1) {
				creature.collision = true;
			}
